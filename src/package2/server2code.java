...
public class server2code extends UnicastRemoteObject implements server2interface {
	...
	public server2code() throws  RemoteException
	{
		super();
	}
	public void listener(int a,int b,String date) throws RemoteException
	{
		...
		alwayslistner2 tl1=new alwayslistner2(cou,a,date);
