...
public class server1code extends UnicastRemoteObject implements server1interface {
	...
	public server1code() throws  RemoteException
	{
		super();
	}
	public void listener(int a,int b,String date) throws RemoteException
	{
		...
		alwayslistner1 tl1=new alwayslistner1(cou,a,date);
